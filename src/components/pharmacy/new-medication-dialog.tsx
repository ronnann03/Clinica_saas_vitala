...
import { createMedication, type PharmacyFormState } from "@/app/dashboard/farmacia/actions";

const initialState: PharmacyFormState = {};

export function NewMedicationDialog() {
  const [open, setOpen] = useState(false);
  const [state, formAction, isPending] = useActionState(createMedication, initialState);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4">
          <div className="w-full max-w-lg rounded-lg bg-white p-6 shadow-lg">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-slate-900">Nuevo medicamento</h2>
            ...
            <form ref={formRef} action={formAction} className="mt-4 space-y-3">
              ...
              <div>
                ...
                <input
                  name="presentation"
                  placeholder="Tableta 500mg, jarabe 120ml, etc."
              ...
              <p className="text-xs text-slate-400">
                El stock se registra ingresando lotes desde el detalle del medicamento.
              </p>
